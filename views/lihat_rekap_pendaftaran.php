                  ...
                  <div class="x_content">
                    ...
                    <form id="form-rekap-pendaftaran" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="jenjang" id="pemilihan-jenjang-rekap-pendaftaran">
          ...
          $.ajax({
            ...
            success: function(msg){
                if(msg.result == 1){
                  ...
                  $('#head-table-rekap').append("<h4>Jenjang "+$('#pemilihan-jenjang-rekap-pendaftaran').find(":selected").text()+"</h4>");
                  $('#body-tables').html("");
